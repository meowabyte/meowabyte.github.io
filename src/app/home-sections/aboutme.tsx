    ...
    return <ModalBody className="grid max-lg:w-4/5 max-md:grid-rows-[0.5fr_2fr] md:grid-cols-[1fr_2fr] gap-5">
        <div class="relative">
            {birthdayMode && avatarLoaded &&
                <img height={70} width={70} alt="Birthday hat" src={bdayHat} class="absolute left-[30%] -translate-x-1/2 -top-20 -rotate-12" />
            }
            <img onLoad={() => setAvatarLoaded(true)} className="justify-self-center" width={400} height={400} src="https://github.com/meowabyte.png?size=400" alt="Avatar" />
        </div>
