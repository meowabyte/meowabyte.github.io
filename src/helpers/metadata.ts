...
const element = (o: Omit<Extract<MetadataItem, { kind: "element" }>, "kind">): MetadataItem => ({ kind: "element", ...o })
...
const GLOBAL_METADATA: MetadataItem[] = [
    ...
    element({
        ...
        props: {
            name: "description",
            content: "Welcome on personal website of mine, here you will find various information about me, including projects, links to social media and more! I hope you'll stay for longer by following me on other platforms!"
        }
    }),
    element({
        type: "meta",
...
metadataMap.set("/", [
    ...
    element({ type: "link", props: { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Roboto+Mono&display=swap" } })
])
...
export function getMetadata(path: string) {
    ...
    const elements = new Set(
        metaArr.filter(m => m.kind === "element")
